...
player.animation_speed = 1 -- Adjust this to change animation speed
...
function player:update(dt)
    ...
    if self.current_frame > #self.current_animation then self.current_frame = 1 end
...
local scale = 2  -- adjust this value to your needs
